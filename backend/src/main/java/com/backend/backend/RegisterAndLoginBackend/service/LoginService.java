...
import com.backend.backend.RegisterAndLoginBackend.strategy.login.EmailAndPasswordLoginStrategy;
...
import com.backend.backend.RegisterAndLoginBackend.strategy.login.GoogleLoginStrategy;
import com.backend.backend.RegisterAndLoginBackend.strategy.login.LoginStrategy;
...
public class LoginService {
    ...
    private static final ImmutableMap<LoginType, Class<? extends LoginStrategy>> loginStrategiesDefinition = ImmutableMap.of(
            ...
            LoginType.GOOGLE, GoogleLoginStrategy.class
    );
